        ...
        <main className="main-content">
          <motion.div variants={containerVariants} initial="hidden" animate="show">
            ...
            <motion.div variants={itemVariants} className="trips-grid">
              {trips.filter(t => filter === 'All Trips' || (t.status || 'Upcoming') === filter).map(trip => (
                <div key={trip.id} className="trip-card">
                  <div className="trip-img-wrapper">
                    <img src={trip.img || 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&q=80&w=600'} alt={trip.title} className="trip-img" />
                    <div className={`status-badge ${(trip.status || 'Upcoming') === 'Upcoming' ? 'status-upcoming' : 'status-completed'}`}>
                  ...
                  <div className="trip-body">
                    ...
                    <div className="trip-detail">
                      ...
                      {trip.destination || trip.description || 'No destination yet'}
                    </div>
                  </div>
