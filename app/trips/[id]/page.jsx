          ...
          <motion.div variants={containerVariants} initial="hidden" animate="show">
            <motion.div variants={itemVariants} className="topbar">
              <div>
                ...
                <h1 className="page-title">Paris Getaway</h1>
              </div>
              <div className="action-btns">
                ...
                <Link href="/trips/1/edit" className="btn-sm btn-outline">Edit Itinerary</Link>
                <Link href="/trips/1/budget" className="btn-sm btn-primary-sm">View Budget</Link>
              </div>
            </motion.div>
