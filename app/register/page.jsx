    ...
    <div className="register-root">
      ...
      <div className="photo-side">
        ...
        <div className="photo-content">
          ...
          <h2 className="hero-text">Join the Journey.</h2>
      ...
      <div className="form-side">
        <div className="form-container">
          <header style={{ marginBottom: '32px', textAlign: 'center' }}>
            <h3 style={{ fontSize: '32px', fontWeight: 700, fontFamily: 'Cormorant Garamond', marginBottom: '8px' }}>Create Account</h3>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p style={{ textAlign: 'center', fontSize: '14px', color: 'var(--slate)', marginTop: '24px' }}>
              Already have an account? <Link href="/login" style={{ color: '#2d4a8a', fontWeight: '600', textDecoration: 'none' }}>Sign in</Link>
            </p>
          </form>
        </div>
      </div>
